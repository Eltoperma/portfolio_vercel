...
<div class="p-4 flex flex-row justify-between m-auto max-h-[600px] max-w-[800px]">
	<div class="w-1/2 from-slate-400 to-transparent">
		...
		<p class="whitespace-normal pt-4">
			Ich bin Tjark Hüter, gebürtiger Kieler und absolviere zurzeit mein duales Studium zum
			Wirtschaftsinformatiker. Nebst Erfahrungen von der Arbeit bei freenet DLS suche ich noch
			Erfahrungen in Hobbyprojekten, sei es Programmieren, Film, Ton, Schnitt oder einfach mal 'ne
			Runde Fahrradfahren.
		</p>
	</div>
	<div class="w-1/2 min-h-[160px] min-w-[160px]">
		<Avatar.Root>
			<Avatar.Image src="pfp.jpg" alt="@Tjark Hüter" />
			<Avatar.Fallback>Tjark Hüter</Avatar.Fallback>
		</Avatar.Root>
	</div>
</div>
...
<div class="m-auto max-w-[800px] p-4 dark:bg-slate-900 shadow-2xl rounded-md">
	...
	<Accordion.Root class="w-full sm:max-w-[70%]">
		<Accordion.Item value="item-1">
			...
			<Accordion.Content
				><ul>
					<li><img src="icons/brit.svg" alt="- " />Englisch</li>
					<li><img src="icons/c.svg" alt="- " />C#</li>
		...
		<Accordion.Item value="item-3">
			...
			<Accordion.Content>
				<ul>
					...
					<li><img src="icons/photoshop.svg" alt="- " />Lightroom</li>
					<li><img src="icons/indesign.svg" alt="- " />Indesign</li>
					<li><img src="icons/illustrator.svg" alt="- " />Illustrator</li>
					<li><img src="icons/cam.svg" alt="- " />Photographie</li>
					<li><img src="icons/filmcam.svg" alt="- " />Videographie</li>
					<li><img src="icons/micro.svg" alt="- " />Audiotechnik & Recording</li>
					<li><img src="icons/davinci.svg" alt="- " />Ton-/Videoschnitt und nachbearbeitung</li>
				</ul>
			</Accordion.Content>
		</Accordion.Item>
	</Accordion.Root>
...
<svelte:head>
	...
	<meta
		name="description"
		content="Willkommen auf der persönlichen Webseite von Tjark Hüter. Hier erfahren Sie mehr über meinen beruflichen Hintergrund, sehen mein Portfolio und können mit mir Kontakt aufnehmen."
	/>
	<meta
		name="keywords"
		content="Tjark Hüter, Portfolio, Kontakt, beruflicher Hintergrund, Fähigkeiten, Erfahrung"
	/>
	...
	<meta
		...
		content="Erfahren Sie mehr über Tjark Hüters berufliche Laufbahn, sehen Sie das Portfolio und finden Sie Kontaktinformationen."
	/>
