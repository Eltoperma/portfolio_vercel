<div class="p-12 whitespace-normal">
	...
	<p><strong>Vertreten durch: </strong>Tjark Hüter</p>
	<p>
		<strong>Kontakt:</strong>
		Telefon: 0178-5186760 E-Mail:
		<a href="mailto:tjarkhueter@gmail.com">tjarkhueter@gmail.com</a><br />
	</p>
	<p>
		<strong>Haftungsausschluss: </strong><strong>Haftung für Inhalte</strong>
		...
		werden wir diese Inhalte umgehend entfernen.<br /><strong>Haftung für Links</strong>
	...
	<p>
		...
		Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich. Der Nutzung von im Rahmen der Impressumspflicht
	...
	<p>
		...
		über Ihre Benutzung dieser Website (einschließlich Ihrer IP-Adresse) wird an einen Server von Google
		in den USA übertragen und dort gespeichert. Google wird diese Informationen benutzen, um Ihre Nutzung
		der Website auszuwerten, um Reports über die Websiteaktivitäten für die Websitebetreiber zusammenzustellen
